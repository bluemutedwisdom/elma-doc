...
project = u'ELMA'
copyright = u'Joerg Heinemann 2012-2014'
...
html_theme_options = {
    ...
    'navbar_title': "ELMA documentation",

    # Tab name for entire site. (Default: "Site")
    'navbar_site_name': "Main Topics",
    ...
    # an arbitrary url.
    'navbar_links': [
        ("Project Home", "http://enterprise-log-management-appliance.org/", True),
        ("Index", "genindex"),
    ],
...
# of the sidebar.
html_logo = "./_static/logo_elma.png"
